...
public class ESM<K extends Comparable<K>, V extends Comparable<V>> extends SM<K, V>
{
   ...
   */
   ...
   /**
      Returns all values to which the specified key is mapped, or an empty array if this
      sorted multimap contains no mapping for the key.
      @param key the key whose associated values is to be returned.
      @return arrray containing the values to which the specified key is mapped, or an
              empty array if this sorted multimap contains no mapping for the key.
   */
   ...
   */ 
   ...
   /**
      Returns an array with the keys of this extended multimap sorted according to their
   ...
   */
   ...
   {
      // support multimap with K-K mappings
      ESM<K,K> m = new ESM();
