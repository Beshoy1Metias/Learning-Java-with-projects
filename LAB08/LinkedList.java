/**
  * Implements a simply-linked list
  *
  * @author A. Luchetta
  * version 06/12/2023
  */
public class LinkedList implements Container
{
   ...
   private class ListNode
   {
      ...
      */
      public ListNode(Object anElement, ListNode aNode)
      {
   ...
   */
   public Object removeFirst()
   {
      ...
      Object e = getFirst();   // throws EmtyLinkedListException if the linked
                               // list is empty
   ...
   */
   ...
   {
      // temporary storage of the element to remove
      Object e = getLast();    // throws EmtyLinkedListException if the linked
                               // list is empty
