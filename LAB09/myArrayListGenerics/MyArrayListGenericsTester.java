 ...
 /**
  * Test class of the MyArrayListGenerics class
  * @see MyArrayListGenerics
  *
  * @version 9-Dec-2013
  * @author Adriano Luchetta
  */
public class MyArrayListGenericsTester
{
   public static void main(String[] args)
   {

      MyArrayListGenerics<String>  v1 = new MyArrayListGenerics();
      MyArrayListGenerics<Integer> v2 = new MyArrayListGenerics();
