/**
  * Collects sorting and search algorithms applicable to array of objects
...
public class ArrayAlgorithms3
{
   ...
   */
   private static int findMinPos(Object[] a, int from)
   {
      ...
      {
         Comparable tmp = (Comparable)a[i];  // note: type cast     
   ...
   */
   private static void merge(Object[] a, Object[] b, Object[] c)
   {
      ...
      {
         if (((Comparable)b[ib]).compareTo(c[ic]) < 0) // note: type cast
         {
            a[ia++] = b[ib++];
         }
         else
   ...
   public static void insertionSort(Object[] a)
   {
      ...
      for (int i = 1; i < a.length; i++)
      {
        // current element to insert
         Comparable cur = (Comparable)a[i]; // note: type cast
   ...
   */
   public static int linearSearch(Object[] a, Object target)
   {
      ...
      {
         if (((Comparable)a[i]).compareTo(target) == 0) // note: type cast
         {
            return i; // FOUND
         }
      }
   ...
   */
   public static int guardedLinearSearch(Object[] a, int size, Object target)
   {
      a[size] = target;
      int i = 0;
      while (((Comparable)a[i]).compareTo(target) != 0) // note: type cast
      {
         i++;
      }
   ...
   /**
      ...
      @return the index in the array of the first occurrence of the specified
              object or - 1 if the specified object is not in the array      
   */
   public static int recursiveBinarySearch(Object[] a, int target)
   {
   ...
   */
   private static int binSearch(Object[] a, int from, int to, Object t)
   {
      ...
      Comparable middle = (Comparable)a[mid]; // note: type cast
